										...
										<div class="panel panel-default">
											<div class="panel-body">
												<div class="form-group">
													...
													<?php echo $form->dropDownList($model,'kode_barang', CHtml::listData(Barang::model()->findAll(),'kode_barang','nama_barang'),array('empty'=>'--Pilih--','class'=>'form-control')); ?>
													<?php echo $form->error($model,'kode_barang'); ?>
												</div>
												<div class="form-group">
													<?php echo $form->labelEx($model,'jumlah'); ?>
													<?php echo $form->textField($model,'jumlah',array('size'=>60,'maxlength'=>200,'class'=>'form-control','id'=>'cek')); ?>
