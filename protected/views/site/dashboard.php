              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  foreach ($rsqlbar as $rb) {
                    ...
                    <strong>Warning!</strong> Barang dengan kode <?php echo '<a href=index.php?r=barang/manage >'.$rb->kode_barang.'</a>' ?> harus di order kembali, <a href="mailto:supplier@gmail.com">Klik</a> untuk email supplier!
                    </div>
                    <?php }else{
                      echo null;
                    }
